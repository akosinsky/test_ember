...
moduleForModel('ember-flexberry-dummy-application-user', 'Unit | Serializer | ember-flexberry-dummy-application-user', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:ember-flexberry-dummy-application-user',
    'transform:file',
